...
class GammaTransform:
    def __init__(self, p=0.5, gamma_min=1.0, gamma_max=1.0) -> None:
        assert 0 <= p <= 1.0
        self.gamma_min = gamma_min
        self.gamma_max = gamma_max
        # print('using GammaTransform')
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    return Compose(
        [
            ...
            # add
            GammaTransform(p=0.5, gamma_min=hyp.gamma_min, gamma_max=hyp.gamma_max),
        ]
    )  # transforms
